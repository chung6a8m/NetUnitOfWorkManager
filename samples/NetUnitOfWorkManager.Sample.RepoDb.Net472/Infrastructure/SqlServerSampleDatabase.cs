...
namespace NetUnitOfWorkManager.Sample.RepoDb.Net472.Infrastructure
{
    public sealed class SqlServerSampleDatabase
    {
        public const string TableName = "[dbo].[NetUnitOfWorkCounter]";

        private readonly string _connectionString;

        public SqlServerSampleDatabase(string connectionString)
        {
